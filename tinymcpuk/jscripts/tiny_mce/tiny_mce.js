...
tinymce.html.Styles=function(d,f){
    ...
    for(g=0;g<j.length;g++){
        ...
        parse:function(s){
            var A={},q,n,y,r,x=d.url_converter,z=d.url_converter_scope||this;
            function p(E,H){
                var G,D,C,F;
                G=A[E+"-top"+H];
                if(!G){
...
function i(F){
    ...
    function D(M){
    var L,H,aa,W,ab,G,J,V,Y,R,Z,ad,P,K,X,F,T,I,ac,ae,Q,U,O=/^([#+\-])?([^\[\/]+)(?:\/([^\[]+))?(?:\[([^\]]+)\])?$/,S=/^([!\-])?(\w+::\w+|[^=:<]+)?(?:([=:<])(.*))?$/,N=/[*?+]/;
    if(M){
        M=d(M);
        if(s["@"]){
            T=s["@"].attributes;
...
function u(F){
    ...
    if(G){
        g(d(G),function(K){
            var I=F.exec(K),J=I[1]==="~",L=J?"span":"div",H=I[2];
            k[H]=k[L];
            p[H]=L;
            if(!J){
                x[H]={}
...
(function(a){
    ...
    b.parse=function(F){
        var n=this,g,H=0,J,C,B=[],O,R,D,r,A,s,N,I,P,x,m,k,u,S,o,Q,G,T,M,f,K,l,E,L,h,y=0,j=a.html.Entities.decode,z,q;
        function v(U){
            var W,V;
            W=B.length;
            while(W--){
...
f.parse=function(x,m){
    var n,I,B,A,D,C,y,r,F,M,z,o,E,L=[],K,u,k,s,p,v,q;
    m=m||{};
...
if(g.remove_trailing_brs){
    f.addNodeFilter("br",function(n,m){
        var r,q=n.length,o,x=b.extend({},h.getBlockElements()),k=h.getNonEmptyElements(),u,s,p,v;
        x.body=1;
        for(r=0;r<q;r++){
            o=n[r];
            u=o.parent;
...
(function(a){
    ...
    e.reset();
    function f(k){
        var u=g[k.type],j,o,s,r,p,v,n,m,q;
        if(!u){
            j=k.name;
            o=k.shortEnded;
            s=k.attributes;
...
split:function(m,l,p){
    ...
    function j(x){
        var u,s=x.childNodes,v=x.nodeType;
        function y(B){
...
(function(a){
    function b(c){
        ...
        function x(){
            ...
            function v(aa,W){
            var ad=O[h],Y=O[V],ac=O[Q],X=O[A],ab=W.startContainer,af=W.startOffset,Z=W.endContainer,ae=W.endOffset;
            if(aa===0){
                return H(ad,Y,ab,af)
                }
                if(aa===1){
...
function l(ad){
    var ac,Z=0,af=0,X,ab,Y,aa,W,ae;
    if(O[h]==O[Q]){
        return f(ad)
        }
    ...
    function i(ac,ad){
    var Y=P(O[Q],O[A]-1),ae,ab,aa,W,X,Z=Y!=O[Q];
    if(Y==ac){
        return M(Y,Z,S,ad)
        }
        ae=Y.parentNode;
...
function R(ac,ad){
    var Z=P(O[h],O[V]),aa=Z!=O[h],ae,ab,Y,W,X;
    if(Z==ac){
        return M(Z,aa,E,ad)
        }
        ae=Z.parentNode;
...
(function(){
    ...
    var d=function(D,e,G,H){
        ...
        if(e.nodeType!==1&&e.nodeType!==9){
            ...
            var A,L,O,z,K,N,M,F,C=true,B=d.isXML(e),E=[],I=D;
        do{
            n.exec("");
            A=n.exec(I);
            if(A){
...
d.filter=function(J,I,M,C){
    var E,e,H,O,L,z,B,D,K,A=J,N=[],G=I,F=I&&I[0]&&d.isXML(I[0]);
    while(J&&I.length){
        for(H in k.filter){
...
relative:{
    "+":function(E,z){
        var B=typeof z==="string",D=B&&!y.test(z),F=B&&!D;
        if(D){
            z=z.toLowerCase()
            }
...
">":function(E,z){
    var D,C=typeof z==="string",A=0,e=E.length;
    if(C&&!y.test(z)){
        z=z.toLowerCase();
        for(;A<e;A++){
            D=E[A];
...
NAME:function(A,D){
    if(typeof D.getElementsByName!=="undefined"){
        var z=[],C=D.getElementsByName(A[1]);
...
filters:{
    ...
    text:function(A){
        var e=A.getAttribute("type"),z=A.type;
...
ATTR:function(D,B){
    var A=B[1],e=d.attr?d.attr(D,A):k.attrHandle[A]?k.attrHandle[A](D):D[A]!=null?D[A]:D.getAttribute(A),E=e+"",C=B[2],z=B[4];
...
var j=k.match.POS,c=function(z,e){
    return"\\"+(e-0+1)
    };
...
if(document.documentElement.compareDocumentPosition){
    ...
    p=function(G,F){
        ...
        var D,z,A=[],e=[],C=G.parentNode,E=F.parentNode,H=C;
    if(C===E){
        return m(G,F)
        }else{
        if(!C){
...
m=function(z,e,A){
    ...
    var z=document.createElement("div"),A="script"+(new Date()).getTime(),e=document.documentElement;
...
if(document.querySelectorAll){
    (function(){
        var e=d,B=document.createElement("div"),A="__sizzle__";
    ...
    if(D.nodeType===1&&D.nodeName.toLowerCase()!=="object"){
        var E=D,F=D.getAttribute("id"),C=F||A,O=D.parentNode,N=/^\s*[+~]/.test(M);
        if(!F){
            D.setAttribute("id",C)
            }else{
            C=C.replace(/'/g,"\\$&")
...
for(var z in e){
    ...
    if(A){
        var C=!A.call(document.createElement("div"),"div"),z=false;
        try{
...
getBookmark:function(s,u){
    var x=this,n=x.dom,h,k,j,o,i,p,q,m="\uFEFF",v;
    function g(z,A){
        var y=0;
    ...
    function l(){
    var z=x.getRng(true),y=n.getRoot(),A={};
...
moveToBookmark:function(o){
    ...
    function l(C){
    var x=m.get(o.id+"_"+C),B,v,z,A,y=o.keep;
    if(x){
        B=x.parentNode;
        if(C=="start"){
            if(!y){
...
getRng:function(m){
    var h=this,i,j,l,k=h.win.document;
    if(m&&h.tridentSel){
...
normalize:function(){
    var h=this,g,k,j;
    function i(n){
        var m,p,l,q=h.dom,s=q.getRoot(),o,r,u;
        function v(z,x){
            var A,y;
            x=x||m;
...
(function(a){
    a.dom.RangeUtils=function(c){
        ...
        this.walk=function(d,s){
            var i=d.startContainer,l=d.startOffset,u=d.endContainer,m=d.endOffset,j,g,o,h,r,q,e;
...
o=function(z){
    var v=37,u=39,y=38,A=40,q=27,s=14,r=13,x=32;
    switch(z.keyCode){
        case v:
            if(i){
            p.moveFocus(-1)
...
init:function(){
    var q,F=this,G=F.settings,C,y,B=F.getElement(),p,m,D,v,A,E,x,r=[];
    k.add(F);
    ...
    function z(s){
    var H=c.get(s),o=c.urls[s]||k.documentBaseURL.replace(/\/$/,""),n;
...
initContentBody:function(){
    var n=this,p=n.settings,q=l.get(n.id),r=n.getDoc(),o,m;
...
n.parser.addNodeFilter("p,h1,h2,h3,h4,h5,h6,div",function(u,v){
    var x=u.length,y,s=n.schema.getNonEmptyElements();
    while(x--){
        y=u[x];
        if(y.isEmpty(s)){
...
focus:function(p){
    var o,v=this,u=v.selection,q=v.settings.content_editable,n,r,s=v.getDoc(),m;
    if(!p){
        n=u.getRng();
        if(n.item){
            r=n.item(0)
...
getParam:function(u,q,m){
    var r=k.trim,p=d(this.settings[u])?this.settings[u]:q,s;
    if(m==="hash"){
        s={};
...
a.Editor.prototype.bindNativeEvents=function(){
    var c=this,f,g=c.settings,j=c.dom,k;
    k={
        mouseup:"onMouseUp",
...
tinymce.ForceBlocks=function(c){
    ...
    function f(){
        var j=a.getStart(),h=c.getBody(),g,k,o,q,p,i,l,m=-16777215;
...
(function(a){
    a.Formatter=function(Z){
        var P={},S=a.each,c=Z.dom,r=Z.selection,u=a.dom.TreeWalker,N=new a.dom.RangeUtils(c),d=Z.schema.isValidChild,I=c.isBlock,m=Z.settings.forced_root_block,s=c.nodeIndex,H=a.isGecko?"\u200B":"\uFEFF",e=/^(src|href|style)$/,W=false,D=true,E,y=c.getContentEditable;
        function B(aa){
...
function X(ad,ak,af){
    var ag=U(ad),al=ag[0],aj,ab,ai,ah=r.isCollapsed();
    function aa(ap,ao){
        ao=ao||al;
        if(ap){
            if(ao.onformat){
...
function C(ac,al,ae){
    var af=U(ac),an=af[0],aj,ai,ab,ak=true;
    function ad(au){
...
function am(ap){
    ...
    function ah(ar){
    var aq=c.get(ar?"_start":"_end"),ap=aq[ar?"firstChild":"lastChild"];
    if(K(ap)){
...
function z(ab,aa,ag,ae){
    var ac=U(aa),ah,af,ad;
    function ai(am,ao,ap){
        var al,an,aj=ao[ap],ak;
        if(ao.onmatch){
...
function f(aa){
    ...
    function p(aa,al,ad){
    var ao,am,ag,ak,ac=aa.startContainer,ah=aa.startOffset,aq=aa.endContainer,aj=aa.endOffset;
    function an(ay){
...
function J(aa){
    ...
    function T(aj,aa,ah){
    var ak="_mce_caret",ab=Z.settings.caret_debug;
    function ac(an){
...
function al(){
    var am=r.getRng(true),an,ap,at,ar,ao,aw,av=[],aq,au;
...
function Q(ab){
    var aa=ab.startContainer,ah=ab.startOffset,ad,ag,af,ac,ae;
...
(function(b){
    ...
    b.EnterKey=function(e){
        ...
        function f(z){
            var v=d.getRng(true),D,i,y,u,o,I,n,j,l,s,F,x,A;
            function C(J){
