...
(function (a)
{
    ...
    a.ui.plugin.add("draggable", "scroll", {
        ...
        drag: function (d)
        {
            ...
            {
                if (!e.axis || e.axis != "x") if (c.overflowOffset.top + c.scrollParent[0].offsetHeight - d.pageY < e.scrollSensitivity) c.scrollParent[0].scrollTop = h = c.scrollParent[0].scrollTop + e.scrollSpeed;
                ...
                if (!e.axis || e.axis != "y") if (c.overflowOffset.left + c.scrollParent[0].offsetWidth - d.pageX < e.scrollSensitivity) c.scrollParent[0].scrollLeft = h = c.scrollParent[0].scrollLeft + e.scrollSpeed;
                else if (d.pageX - c.overflowOffset.left < e.scrollSensitivity) c.scrollParent[0].scrollLeft = h = c.scrollParent[0].scrollLeft - e.scrollSpeed
            }
            else
            {
                if (!e.axis || e.axis != "x") if (d.pageY - a(document).scrollTop() < e.scrollSensitivity) h = a(document).scrollTop(a(document).scrollTop() - e.scrollSpeed);
                ...
                if (!e.axis || e.axis != "y") if (d.pageX - a(document).scrollLeft() < e.scrollSensitivity) h = a(document).scrollLeft(a(document).scrollLeft() - e.scrollSpeed);
    ...
    a.widget("ui.resizable", a.ui.mouse, {
        ...
        _respectSize: function (e)
        {
            var h = this._vBoundaries,
                ...
                f = c(e.width) && h.minWidth && h.minWidth > e.width,
...
(function (a)
{
    a.widget("ui.sortable", a.ui.mouse, {
        ...
        _mouseDrag: function (d)
        {
            ...
            if (this.options.scroll)
            {
                ...
                if (this.scrollParent[0] != document && this.scrollParent[0].tagName != "HTML")
                {
                    ...
                    else if (d.pageY - this.overflowOffset.top < c.scrollSensitivity) this.scrollParent[0].scrollTop = e = this.scrollParent[0].scrollTop - c.scrollSpeed;
                ...
                {
                    if (d.pageY - a(document).scrollTop() < c.scrollSensitivity) e = a(document).scrollTop(a(document).scrollTop() - c.scrollSpeed);
        ...
        refreshPositions: function (d)
        {
            ...
            else for (c = this.containers.length - 1; c >= 0; c--)
            {
...
function (a, d)
{
    ...
    a.extend(a.easing, {
        ...
        easeInOutBounce: function (n, k, m, p, q)
        {
            ...
            return a.easing.easeOutBounce(n, k * 2 - q, 0, p, q) * 0.5 + p * 0.5 + m
        }
    })
}(jQuery);
(function (a)
